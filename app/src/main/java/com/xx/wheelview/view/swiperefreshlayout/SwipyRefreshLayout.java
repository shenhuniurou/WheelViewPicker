...
package com.zj.wheelview.view.swiperefreshlayout;
 ...
 * <p>
 * This layout_store should be made the parent of the view that will be refreshed as a
 * result of the gesture and can only support one direct child. This view will
 * also be made the target of the gesture and will be forced to match both the
 * width and the height supplied in this layout_store. The SwipeRefreshLayout does not
...
public class SwipyRefreshLayout extends ViewGroup {
    ...
    /**
     * @return Whether it is possible for the child view of this layout_store to
