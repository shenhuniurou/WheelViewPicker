...
public class WheelView extends View {
	...
	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0x6F000000;

	/** Top and bottom shadows colors */
	private static final int[] SHADOWS_COLORS = new int[] { 0xFF888888,
	...
	/** Additional width for items layout_store */
	...
	/**
	 * Calculates desired height for layout_store
	 * 
	 * @param layout
	 *            the source layout_store
	 * @return the desired layout_store height
	 */
	 ...
	 * 
	 * @param widthSize
	 *            the input layout_store width
	 * @param mode
	 *            the layout_store mode
	 ...
	 * 
	 * @param widthItems
	 *            width of items layout_store
	 * @param widthLabel
	 *            width of label layout_store
	 */
	...
	/**
	 * Draws value and label layout_store
	 * 
	 * @param canvas
	 *            the canvas for drawing
	 */
